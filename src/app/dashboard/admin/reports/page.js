...
export default function AdminReportsPage() {
  ...
  return (
    <div className="space-y-6 pb-10 max-w-[1400px] mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
      <div>
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">System Reports</h1>
        <p className="text-xs text-slate-400 font-medium mt-0.5">Platform-wide analytics and reporting</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col items-center justify-center p-20 text-center">
        ...
        <p className="text-sm text-slate-500 font-medium max-w-md mx-auto">
          The global reporting dashboard is currently under development. Soon you will be able to generate and export insights about platform growth, revenue, and clinic activity.
        </p>
      </div>
    </div>
  );
