  ...
  return (
    <div className="space-y-6 pb-10 max-w-[1400px] mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
      <div>
        ...
        <p className="text-xs text-slate-400 font-medium mt-0.5">Track system-wide administrative actions and security events</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col items-center justify-center p-20 text-center">
        ...
        <p className="text-sm text-slate-500 font-medium max-w-md mx-auto">
          The audit logs interface is currently under development. Soon you will be able to review detailed histories of all critical actions performed on the platform.
        </p>
      </div>
    </div>
  );
